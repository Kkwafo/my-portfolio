...
const resources = {
  en: {
    translation: {
      ...
      aboutDescription: "I am a passionate and driven individual, always eager to grow and innovate. While my true calling lies in developing web applications, I have also pursued a path in education, understanding that knowledge is one of the most powerful tools for change.",
      aboutDescription2: "Although I am not currently practicing as a teacher, my passion for technology extends beyond coding. I firmly believe in empowering others to explore new technologies, helping them navigate the ever-evolving digital landscape. My goal is not just to teach programming but to foster a mindset of problem-solving, creatives skills, critical thinking, and innovation.",
      aboutDescription3: '"Technology is not just about writing code; it is about building a sustainable future. I am deeply committed to spreading awareness of renewable energy, environmental sustainability, and fostering a culture of respect and collaboration. The world progresses when we work together, supporting each other as we navigate challenges, much like a team rowing against the tide, seeking the right currents to move forward."',
      aiTitle: "The Role of AI in Technology",
